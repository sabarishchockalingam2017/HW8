...
void LCD_drawXBar(unsigned short, unsigned short, unsigned short, unsigned char, unsigned char, short);
void LCD_drawYBar(unsigned short, unsigned short, unsigned short, unsigned char, unsigned char, short);
#endif
